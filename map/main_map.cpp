...
void test_ft_index_operator()
{
    ...
    mapa.insert(ft::pair<std::string, int>("a", 1));
    mapa.insert(ft::pair<std::string, int>("b", 2));
    mapa.insert(ft::pair<std::string, int>("c", 3));
...
void test_ft_capacity()
{
    ...
    ft::map<int, int> map1;
    map1.insert(ft::pair<int, int>(1, 2));
    map1.insert(ft::pair<int, int>(2, 3));
    map1.insert(ft::pair<int, int>(3, 4));
...
void test_ft_insert()
{
    ...
    mapa.insert(ft::pair<std::string, int>("c", 3));
    std::cout << "mapa contains:" << " ";
    mapa.insert(++++mapa.begin(), ft::pair<std::string, int>("d", 4));
    print_map(mapa);
...
void test_ft_erase()
{
    ...
    mapa.insert(ft::pair<int, int>(1, 3));
...
{
    ft::map<int, int> m;
    m.insert(ft::pair<int, int>(10, 9));
    m.insert(ft::pair<int, int>(9, 8));
    m.insert(ft::pair<int, int>(8, 7));
    m.insert(ft::pair<int, int>(7, 6));
    std::cout << "m contains:" << " ";
    print_map(m);

    ft::map<int, int> m1;
    m1.insert(ft::pair<int, int>(5, 4));
    m1.insert(ft::pair<int, int>(4, 3));
    m1.insert(ft::pair<int, int>(3, 2));
...
{
    ft::map<int, int> m;
    m.insert(ft::pair<int, int>(100, 1));
    m.insert(ft::pair<int, int>(200, 2));
    m.insert(ft::pair<int, int>(300, 3));
    if (m.count(300))
...
void test_ft_lower_upper_bound()
{
    ...
    m.insert(ft::pair<int, int>(200, 2));
    m.insert(ft::pair<int, int>(300, 3));
    m.insert(ft::pair<int, int>(400, 4));
    m.insert(ft::pair<int, int>(500, 5));
